                ...
                <div className="w-[100%] h-[150px] bg-blue-700/0 px-2 mt-20 p-4 flex">
                    <div className="w-[100%] flex h-[100%] text-white bg-white/5 rounded-xl">
                     <div className="w-[70%] py-3 px-3 ">
                        ...
                        <div className="flex">
                        <p className="text-2xl mt-5 ml-auto mr-4 text-white font-extrabold">{`Plugs`}</p>  
                        <p className="text-2xl mt-5 mr-auto ml-4 text-white font-extrabold">{`${reffs && reffs.length}`}</p>
                        </div>
                            </div>
                        </div>
                     </div>
                        ...
                        <div className="w-[100%] mt-2 mb-2 h-auto flex rounded-xl py-4 px-3 bg-black/15">
                            <div className="ml-1 mr-3 w-[15%]">
                                <div className="bg-black/50 flex items-center justify-center rounded-full w-12 h-12">
                                    {`${userBoard.username === null  ? 'U' : userBoard?.username?.substring(0,1)}`}
                                </div>
                            </div>
                            <div className="mt-1 w-[85%] text-sm flex ">
                                <div className="ml-1 mr-auto">
                                    <p className="mt-0.5 mb-0.5 font-bold text-[13px]">{userBoard.username === null ? 'User' : userBoard?.username}</p>
                       ...
                       leads && leads.map((item,i) => (
                        ...
                        <div 
                          key={i} className="w-[100%] mt-2 mb-2 h-auto flex rounded-xl py-3 px-3 bg-white/10">
                            <div className="ml-1 mr-3 w-[15%]">
                                <div className="bg-black/50 flex items-center justify-center rounded-full w-12 h-12">
                                    {`${item?.username === null  ? 'U' : item?.username?.substring(0,1)}`}
                                </div>
                            </div>
                            <div className="mt-1 w-[85%] text-sm flex ">
                                <div className="ml-2 mr-auto">
