                ...
                {canClaim ? (
                  ...
                  <>
                    <div className="bg-black/30 w-[90%] rounded-2xl text-white py-2 flex items-center justify-center h-[52px]">
                      <div className="text-[20px] ml-2 mr-2 flex text-blue-500/70 font-extrabold">
                      <div className="text-[16px] mt-0.5 mr-2 ml-2 font-light text-white/70">Claim Available in</div>
                        {`${formatTimeRemaining(
                          timeRemaining
                        )}`}
                      </div>
