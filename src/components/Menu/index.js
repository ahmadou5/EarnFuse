...
export const BackMenu = () => {
  ...
  return (
    <div
      ...
      className=" w-[60px] h-[60px] ml-5 mr-auto rounded-full px-1.5 z-100 bg-[#2f70d8]/35 mb-6 text-white/75  fixed inset-x-0 bottom-1 flex justify-center items-center"
    >
