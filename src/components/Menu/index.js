    ...
    return (
      <>
        ...
        <div
          ...
          className=" w-[93%] ml-auto mr-auto rounded-3xl py-1 px-1.5 z-100 bg-black/45 mb-4  fixed inset-x-0 bottom-1 flex justify-center items-center"
        >
          <div className="lg:py-2.5 py-1.5 lg:px-2.5 px-1.5  mt-auto mb-auto ml-auto mr-auto w-[98%] flex flex-row  h-[90%]">
            <div onClick={() => {
              ...
              setIsWallet(true)
                ...
                <p className={`font-light mt-1 text-white text-[12px]`}>Task</p>
            </div>
